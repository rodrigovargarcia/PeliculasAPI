...
namespace PeliculasAPI.Tests
{
    ...
    // CREAMOS ESTA CLASE DEBIDO A QUE EL PROVEEDOR EN MEMORIA DE ENTITYFRAMEWORK NO FUNCIONA CON NETTOPOLOGYSUITE
    // POR ESTO CREAMOS ESTA BASE DE DATOS DE LOCAL DB
    //      Es decir, básicamente con localDB podemos crear una base de datos cada vez que
    //      corramos nuestro TestSuite y una vez terminada la ejecución, la borramos.
    ...
    public class LocalDbDatabaseInitializer
    {
        ...
        [AssemblyInitialize]
        public static void Initialize(TestContext testContext)          // -> Éste método se ejecuta al inicio del CONJUNTO de pruebas unitarias (testSuite),                                                                        
        {
            DeleteDB();                                                 //  NO con cada prueba unitaria
            CreateDB();
        }
